# Generated by Django 3.1.7 on 2021-03-21 04:09
...
import learn_pratice.apps.blog.utils.tools
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(default='default.jpg', upload_to=learn_pratice.apps.blog.utils.tools.user_directory_path, verbose_name='头像')),
            ],
            options={
                'db_table': 'blog_user',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='发信者ID')),
            ],
        ),
        migrations.CreateModel(
            name='PhotoSort',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='所属用户ID')),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
            fields=[
                ...
                ('photo_src', models.ImageField(blank=True, null=True, upload_to=learn_pratice.apps.blog.utils.tools.user_directory_path, verbose_name='图片路径')),
                ('user_id', models.IntegerField(verbose_name='所属用户ID')),
                ('photo_sort', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.photosort')),
            ],
        ),
        migrations.CreateModel(
            name='ArticleSort',
            fields=[
                ...
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='分类所属用户')),
            ],
        ),
        migrations.CreateModel(
            name='Article',
            fields=[
                ...
                ('article_sort', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.articlesort', verbose_name='所属分类')),
            ],
        ),
        migrations.AddField(
            model_name='userinfo',
