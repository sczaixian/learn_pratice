...
class Article(models.Model):
    ...
    article_click = models.IntegerField(verbose_name='查看人数')
    article_sort = models.ForeignKey(to='ArticleSort', to_field='sort_article_id', on_delete=models.CASCADE, verbose_name='所属分类')
